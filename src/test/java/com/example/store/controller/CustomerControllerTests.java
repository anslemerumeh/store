...
class CustomerControllerTests {
    ...
    @Test
    void testSearchCustomersByNameNoResults() throws Exception {
        when(customerRepository.findByNameContaining("xyz")).thenReturn(List.of());

        mockMvc.perform(get("/customer").param("name", "xyz"))
                .andExpect(status().isOk())
